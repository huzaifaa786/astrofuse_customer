...
Future<bool> callOnFcmApiSendPushNotifications(
  ...
  try {
    ...
    final headers = {
      ...
      'Authorization':
          'key=AAAA16uewd8:APA91bGfpaF57JRfrqEUhH-wPmMLz30O7moGcj0y60OPzpPtj1KE4fvzx5BwmOd1rDU5j1bm_J4P006SO7scsGsu6NAY9jJ4fqC2u5lqng9XcOmRsSCXVpf8ENhvPKe6j5-g2IDmSocx' // 'key=YOUR_SERVER_KEY'
    };
...
String getSystemFlagValueForLogin(String flag) {
  ...
  log('hello from getSystemFlagValueForLoflag ---- >gin flag-$flag  $value');
...
Future<Map<String, String>> getApiHeaders(bool authorizationRequired) async {
  ...
  if (authorizationRequired) {
    ...
    print("sp!.getString()---------${sp!.getString("token")}");
    String token =

     sp!.getString("token") ?? "invalid token";
