                        ...
                        itemBuilder: (context, index) {
                          ...
                          return InkWell(
                            onTap: () async {
                              ...
                              print("kundliController.searchKundliList[index].name-----> ${formattedDay}--${formattedHour}----${formattedMint}---${formattedYear}----${kundliController.searchKundliList[index].latitude}----${kundliController.searchKundliList[index].longitude}----${kundliController.searchKundliList[index].timezone}");
