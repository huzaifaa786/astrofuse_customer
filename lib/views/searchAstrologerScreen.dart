...
class SearchAstrologerScreen extends StatelessWidget {
  ...
  baseSearchController.SearchController searchControllerr =
      Get.find<baseSearchController.SearchController>();
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        baseSearchController.SearchController searchController =
            Get.find<baseSearchController.SearchController>();
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: GetBuilder<baseSearchController.SearchController>(
        ...
        body: GetBuilder<baseSearchController.SearchController>(
            builder: (searchController) {
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return GetBuilder<
                                    baseSearchController.SearchController>(
                                builder: (c) {
