      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            /// Hide Walet Simbol Funtionalyty in custmor app
           /* InkWell(
              onTap: () async {
                                        ...
                                        child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.center, children: [
                                                  ...
                                                  child: GetBuilder<HomeController>(builder: (h) {
                                                    return Container(
                                                      ...
                                                      child: Column(mainAxisSize: MainAxisSize.min, children: [
                                                        ...
                                                        Text(homeController.lan[index].subTitle,style: Get.textTheme.bodyText2!.copyWith(fontSize: 12),
                                                        )
                                                      ]),
                                                    );
                                                  }),
                                          ...
                                          Container(
                                            ...
                                            child: ElevatedButton(
                                              onPressed: () async {
                                                print("${homeController.lan[homeController.selectedIndex].lanCode}");
