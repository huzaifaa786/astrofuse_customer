    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        bottomSheet: GetBuilder<ChatController>(builder: (C) {
          return chatController.chatBottom
              ? Container(
                  color: Get.theme.primaryColor,
                  height: 40,
                  width: Get.width,
                  ...
                  child: Row(
                    children: [
                      ...
                      TextButton(
                        ...
                        onPressed: () async {
                          print(
                              "asto check ---> ${cController.bottomAstrologerName}----> ${cController.bottomAstrologerProfile}---> ${cController.bottomFirebaseChatId}---> ${cController.bottomChatId} ---> ${cController.bottomFcmToken}---> ${cController.bottomAstrologerId}   ");
                          ...
                          Get.to(() => IncomingChatRequest(
                                ...
                                fireBasechatId:
                                    cController.bottomFirebaseChatId ?? "",
                                chatId: cController.bottomChatId ?? 0,
                                astrologerId:
                                    cController.bottomAstrologerId ?? 0,
                                fcmToken: cController.bottomFcmToken ?? "abcde",
                              ));
//                           Get.to(() => IncomingChatRequest(
//                             astrologerName:"Test Modi",
//                             profile: "Astrologer",
// fireBasechatId: "54_393",
//                             chatId: 301,
//                             astrologerId:  391,
